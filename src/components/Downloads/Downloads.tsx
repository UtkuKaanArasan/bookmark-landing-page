...
const Downloads: FC = () => {
    return (
        <div className="my-32 lg:px-16">
            <h1 className="text-2xl font-bold mx-2 my-3 lg:px-32">
            ...
            <div className="lg:flex">
                <Card relative="0" Logo={chromeLogo} Name="Chrome" Version={62} />
                <Card relative="32px" Logo={firefoxLogo} Name="Firefox" Version={55} />
                <Card relative="4rem" Logo={operaLogo} Name="Opera" Version={46} />
            </div>
        </div>
    )
}
